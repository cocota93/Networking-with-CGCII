...
1. CGCII Server DB Query Classes
...
2. CGCII Server DB Query Classes의 주요 클래스 및 구성 요소들
   ...
   1) Querier
      ...
      - CGServerQuery::DB::CQuerierBatch
      - CGServerQuery::DB::CQuerierBatchLambda
      - CGServerQuery::DB::CQuerierBatchWait

   2) Query
      - CGServerQuery::DB::IQuery<T>
      - CGServerQuery::DB::CQueryStatic<T>
