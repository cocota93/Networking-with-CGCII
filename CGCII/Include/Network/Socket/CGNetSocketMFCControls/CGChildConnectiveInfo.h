...
// 
//-----------------------------------------------------------------------------
class CGNETSOCKETMFCCONTROL_EXT_CLASS CCGChildConnectiveInfo : public CCGChildDialog
{
	DECLARE_DYNAMIC(CCGChildConnectiveInfo)

// ****************************************************************************
// Constructor/Destructor)
// ----------------------------------------------------------------------------
public:
			CCGChildConnectiveInfo(const CGNet::IO::Statistics::CONNECTIVE_INFO* p_pInfo=nullptr, CWnd* pParent=nullptr);   // standard constructor
	virtual ~CCGChildConnectiveInfo();
