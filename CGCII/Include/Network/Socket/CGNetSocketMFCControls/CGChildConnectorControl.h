...
//-----------------------------------------------------------------------------
//
// CCGChildConnectorControl
//
// 1. CCGChildConnectorControl란!
//    1) Socket의 상태정보를 표시하는 Dialog
//    2) DoModal()로 띄우는 것으로 작성하였다.
// 
// 
//-----------------------------------------------------------------------------
class CGNETSOCKETMFCCONTROL_EXT_CLASS CCGChildConnectorControl : public CCGChildDialog
{
	DECLARE_DYNAMIC(CCGChildConnectorControl)

// ****************************************************************************
// Constructor/Destructor)
// ----------------------------------------------------------------------------
public:
			CCGChildConnectorControl(CGNet::IO::IConnector* _pConnector=nullptr, CWnd* pParent=nullptr);   // standard constructor
	virtual ~CCGChildConnectorControl();
