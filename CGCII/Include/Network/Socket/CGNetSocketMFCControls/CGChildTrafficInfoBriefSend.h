...
// 
//-----------------------------------------------------------------------------
class CGNETSOCKETMFCCONTROL_EXT_CLASS CCGChildTrafficInfoBriefSend : public CCGChildDialog
{
	DECLARE_DYNAMIC(CCGChildTrafficInfoBriefSend)

// ****************************************************************************
// Constructor/Destructor)
// ----------------------------------------------------------------------------
public:
			CCGChildTrafficInfoBriefSend(const CGNet::IO::Statistics::TRAFFIC_INFO* p_pInfo=nullptr, CWnd* pParent=nullptr);   // standard constructor
	virtual ~CCGChildTrafficInfoBriefSend();
