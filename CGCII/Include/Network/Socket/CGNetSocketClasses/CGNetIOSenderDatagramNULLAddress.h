...
inline bool NDatagramNULLAddress::Send(_In_ const CCGBuffer& _Buffer)	
{
	...
	// 1) 전송한다.
	return	RequestSend(nullptr, &_Buffer, 1, _Buffer.get_reference(), nullptr);
}

inline	bool NDatagramNULLAddress::ValidateSendMessage(_In_ const CCGBuffer* _Buffer, _In_ int _countBuffer)
{
