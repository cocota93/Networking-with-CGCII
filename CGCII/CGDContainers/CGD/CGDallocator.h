...
//
// 2. CGD::list의 핵심! Function의 기능 설명.
//    1) Add                하하하
//    2) Detach             호호호
//
// 3. CGD::list의 주요 사용 용도
//    프로그래머 맘대로...
//
//
//-----------------------------------------------------------------------------
...
public:
	...
	pointer				allocate(size_type _Count)					{	if(_Count<0) _Count=0;	return ((TDATA*)::operator new(_Count * sizeof (TDATA)));}
